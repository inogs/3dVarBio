subroutine cp_o2o_stat
  ...
  if(MyId .eq. 0) then
     write(drv%dia,*) 'writing o2o structure (only copy from RSTbefore)'
     write(*,*) 'writing o2o structure (only copy from RSTbefore)'
  endif
